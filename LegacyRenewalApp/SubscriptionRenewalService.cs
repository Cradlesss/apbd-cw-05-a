...
namespace LegacyRenewalApp
{
    public class SubscriptionRenewalService
    {
            ...
            bool useLoyaltyPoints)
        {
            ...
            var resolver = ResolveDiscount.Resolve(baseAmount, customer, seatCount, plan.IsEducationEligible, useLoyaltyPoints);
            var discountAmount = resolver.GetDiscountAmount();
            var notes = resolver.GetNotes();
